...
public class MyPointcut {
    ...
    public boolean execution(){
        //com.lingyi.laboratory.spring.aop.PointcutService类里的m1方法
        return doMatches("execution(* com.lingyi.laboratory.spring.aop.PointcutService.m1(..))");
    }
    ...
    public boolean within(){
        //com.lingyi.laboratory.spring.aop.PointcutService类里的所有方法
        return doMatches("within(com.lingyi.laboratory.spring.aop.PointcutService)");
    };
    ...
    public boolean thisI(){
        return doMatches("this(com.lingyi.laboratory.spring.aop.PointcutService)");
    }
    ...
    public boolean target(){
        return doMatches("target(com.lingyi.laboratory.spring.aop.PointcutService)");
    }
