...
import com.lingyi.laboratory.spring.beanDefinition.*;
...
public class BeanDefinition {
    ...
    @Test
    void parseXml(){
        ClassPathXmlApplicationContext applicationContext = new ClassPathXmlApplicationContext("classpath:META-INF/lingyi-user.xml");
